...
class APIRequestTests: XCTestCase {
    ...
    func testHasError() {
        ...
        XCTAssertThrowsError(try APIRequest<BlockNumber>(method: "get_tip_block_number").decode(data)) { error in
            XCTAssertEqual(
    ...
    func testUnmatchedId() {
        ...
        XCTAssertThrowsError(try APIRequest<BlockNumber>(id: 2, method: "get_tip_block_number").decode(data)) { error in
            XCTAssertEqual(
                error.localizedDescription,
